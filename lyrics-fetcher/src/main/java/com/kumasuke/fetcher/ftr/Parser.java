...
import static com.kumasuke.util.Tools.toList;
import static com.kumasuke.util.Tools.toSet;
...
abstract class Parser {
    ...
    // 用于去除两端半角 / 全角空格的正则表达式
    private static final Pattern superTrimPattern;
    // 用于去除两端 Html 和普通空格的正则表达式
    private static final Pattern htmlTrimPattern;
